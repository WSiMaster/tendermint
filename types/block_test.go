...
func TestBlockAddEvidence(t *testing.T) {
	...
	block := MakeBlock(h, txs, commit, evList,nil)
...
func TestBlockMakePartSetWithEvidence(t *testing.T) {
	...
	partSet := MakeBlock(h, []Tx{Tx("Hello World")}, commit, evList,nil).MakePartSet(512)
	assert.NotNil(t, partSet)
...
func TestBlockHashesTo(t *testing.T) {
	...
	block := MakeBlock(h, []Tx{Tx("Hello World")}, commit, evList,nil)
...
func TestBlockProtoBuf(t *testing.T) {
	...
	b1 := MakeBlock(h, []Tx{Tx([]byte{1})}, &Commit{Signatures: []CommitSig{}}, []Evidence{},nil)
	b1.ProposerAddress = tmrand.Bytes(crypto.AddressSize)

	b2 := MakeBlock(h, []Tx{Tx([]byte{1})}, c1, []Evidence{},nil)
	...
	b3 := MakeBlock(h, []Tx{}, c1, []Evidence{},nil)
